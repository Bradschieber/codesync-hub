...
const STATUS_LABELS = {
  ...
  deposit_pending: { label: "Deposit Pending", color: "#5F2530", bg: "#F5E6E9" },
  deposit_paid: { label: "Deposit Paid", color: "#065F46", bg: "#D1FAE5" },
  deposit_paid_pending_admin_release: { label: "Deposit Held — Awaiting Platform Approval", color: "#5F2530", bg: "#F5E6E9" },
  ...
  final_payment_pending: { label: "Awaiting Final Payment", color: "#5F2530", bg: "#F5E6E9" },
