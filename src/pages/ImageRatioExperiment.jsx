    ...
    <div className="flex flex-col items-center gap-3 w-full">
      ...
      <div className={`flex flex-col items-center gap-1`}>
        ...
        <span
          ...
          style={{
            backgroundColor: highlight ? "#F9E5E8" : "#F0EFED",
            color: highlight ? "#7A1526" : "#5A6A7A",
          }}
        >
          {sublabel}
        </span>
      ...
      <p
        ...
        style={{ color: highlight ? "#7A1526" : "#888" }}
      >
        {note}
      </p>
    </div>
  ...
  return (
    <div style={{ backgroundColor: "#F7F6F3", minHeight: "100vh" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          <h2 className="text-sm font-bold uppercase tracking-widest mb-3" style={{ color: "#7A1526" }}>
            Recommendation
          </h2>
