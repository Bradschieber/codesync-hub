...
export default function BuilderOnboarding() {
  ...
  if (loading) return (
    <div className="fixed inset-0 flex items-center justify-center" style={{ backgroundColor: "#F5E6E9" }}>
      <div className="w-8 h-8 rounded-full animate-spin" style={{ border: "3px solid #E3E0D8", borderTopColor: NAVY }} />
    </div>
  );

  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#F5E6E9" }}>
