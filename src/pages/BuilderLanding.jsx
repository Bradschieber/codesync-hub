    ...
    <div className="bg-[#FDFBF8] text-[#1B2B4B] font-sans">
      ...
      <section className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold mb-6" style={{ color: NAVY }}>
          A storefront alone doesn't bring buyers
        </h2>
        <div className="text-gray-500 text-base leading-relaxed space-y-4">
          <p>
            Many independent builders already have a website, a social media following, or a storefront on a larger marketplace. Those tools can help, but they still leave builders doing the hardest part themselves: attracting the right buyers.
          </p>
          <p>
          ...
          <p>
            Stringed Collective gives builders more than a storefront. We provide the marketplace, and we work to drive the right kind of buyer traffic to it.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6 py-20">
          ...
          <div className="grid sm:grid-cols-2 gap-8">
            {[
              ...
              {
                icon: Globe,
                title: "Active marketplace promotion",
                body: "Stringed Collective is built to promote independent builders and attract players who are looking for something beyond mass-market instruments. We provide the marketplace, and we work to bring the right kind of buyers to it."
              },
              {
                icon: Fingerprint,
